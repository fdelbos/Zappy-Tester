...
QMAKE    = /usr/bin/qmake
zappy-tester.pbproj/project.pbxproj: zappy\ tester.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o zappy-tester.pbproj/project.pbxproj zappy\ tester.pro
